...
document.write('<param name="movie" value="../javascript/musicplayer.swf?playlist=playerlist" />');
document.write('<param name="quality" value="high" />');
document.write('<param name="wmode" value="transparent" />');
document.write('<embed src="../javascript/musicplayer.swf?playlist=playerlist" quality="high" wmode="transparent"');
